...
namespace RRL
{
    public class polaczenieBazaDanych
    {
        ...
        public void delItem(int id)
       {
        ...
        //  ARTYKUŁY: WYZERUJ STAN ARTYKUŁU XYZ
        public void changeItemamounttozero(int id)
        {
        ...
        //  ARTYKUŁY: WYZERUJ STAN ARTYKUŁU XYZ W STORAGEPLACES
        public void changeItemamountStorageplacetozero(int id)
        {
            ...
            try
            {
                ...
                // the stored procedure
                SqlCommand cmd = new SqlCommand(
                    "changeitemamount_storageplacetozero", conn);
        ...
        public void delBalk(int id)
        {
            ...
            try
            {
                ...
                // to execute a stored procedure
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@BalkId", id));
                rdr = cmd.ExecuteReader();
        ...
        // CUBBIES: SPRAWDZENIE CZY CUBBIES JEST PUSTY
        public bool checkCubbieIfEmpty(int id)
        {
            bool istnieje = false;
            ...
            using (SqlConnection conn = new SqlConnection(db_path))
            {
                ...
                SqlCommand cmd = new SqlCommand("select dbo.checkcubbieifempty(@id)", conn);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add(new SqlParameter("@id", id));
                ...
                try
                {
                    ...
                    {
                        istnieje = true;
                        MessageBox.Show("LOKALIZACJA NIE JEST PUSTA! USUŃ MIEJSCA MAGAZYNOWE!", "UWAGA!",MessageBoxButtons.OK,MessageBoxIcon.Error);
                    }
        ...
        // CUBBIES: SPRAWDZENIE CZY CUBBIES JEST PUSTY_dla kolorowania storageplaces
        public bool checkCubbieIfEmpty2(int id)
        {
            bool istnieje = false;
        ...
        // BALKS: ZMIANA POZYCJI BALK
        public void editBalk(int id,  int pozx, int pozy, int wys, int szer, int rackid, string rackname)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Height", wys));
                cmd.Parameters.Add(new SqlParameter("@Width", szer));
                cmd.Parameters.Add(new SqlParameter("@RackId", rackid));
                cmd.Parameters.Add(new SqlParameter("@RackName", rackname));
        ...
        // BALKS: ZMIANA POZYCJI BALK
        public void addBalk_byCreator(int id, int pozx, int pozy, int wys, int szer, int rackid, string rackname)
        {
        ...
        // CUBBIE: DODANIE MIEJSC MAGAZYNOWYCH KREATOREM
        public void addcubbie_byCreator(int id, int pozx, int pozy, int wys, int szer, string name)
        {
        ...
        // CUBBIES: ZMIANA NAZWY REGAŁU ( POJ. BELKA)
        public void editBalkName(int id, string name)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@BalkId", id));
                cmd.Parameters.Add(new SqlParameter("@RackName", name));
        ...
        // CUBBIES: ZMIANA ROZMIARU BELKI
        public void editBalkSize(int id, int x, int y)
        {
        ...
        //ŁADUJ BALKS
        public void loadBalks(DataGridView dgv)
        {
            string sql = "select*from dbo.ViewBALKS";
            SqlConnection connection = new SqlConnection(db_path);
            SqlDataAdapter dataadapter = new SqlDataAdapter(sql, connection);
            DataSet ds = new DataSet();

            connection.Open();
            dataadapter.Fill(ds, "viewBALKS");
            connection.Close();
            dgv.DataSource = ds;
            dgv.DataMember = "viewBALKS";
        ...
        //BALKS: NASTĘPNY WOLNY ID - POTRZEBNY PRZY TWORZENIU
        public int nextfreeBalkid()

        {
            ...
            using (SqlConnection conn = new SqlConnection(db_path))
            {
                ...
                SqlCommand cmd = new SqlCommand("select dbo.getnextidBalks()", conn);
                cmd.CommandType = CommandType.Text;
        ...
        // UŻYTKOWNICY: EDYTUJ STORAGEPLACE
        public void editStorageplace(int id, string name, int curr, int dif, int max, int iditem)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@StorageId", id));
                cmd.Parameters.Add(new SqlParameter("@StorageName", name));
                cmd.Parameters.Add(new SqlParameter("@CurrentInventory", curr));
                cmd.Parameters.Add(new SqlParameter("@DiffInventory", dif));
                cmd.Parameters.Add(new SqlParameter("@MaxInventory", max));
                cmd.Parameters.Add(new SqlParameter("@ItemId", iditem));
        ...
        // STORAGEPLACES : USUŃ WSZYSTKIE STORAGEPLACE
