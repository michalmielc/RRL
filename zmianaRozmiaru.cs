...
namespace RRL
{
    public partial class zmianaRozmiaru : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (opcja == 0)
                {
                    ...
                    balk_position.x = int.Parse(textBox1.Text);
                    balk_position.y = int.Parse(textBox2.Text);
                }
                ...
                if (opcja == 1|| opcja==2)
                {
                    ...
                    balk_position.xTemp = int.Parse(textBox1.Text);
                    balk_position.yTemp = int.Parse(textBox2.Text);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            balk_position.xTemp = balk_position.x;
            balk_position.yTemp = balk_position.y;
